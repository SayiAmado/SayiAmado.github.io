...
window.addEventListener("load", () => {
	let canvasConfig = {
		...
		//bg: "url('IMAGENES/COLORES/001.jpg')",
		bg: "radial-gradient(#85c0c9, #014a48)",
	...
	let canvas = document.createDOMElem("canvas", 
																			{ class: canvasConfig.class, 
																				...
																				style: `background: ${canvasConfig.bg} no-repeat center center / cover` }),
	...
	let particleConfig = {
		...
		lc: "transparent"	 // color of binding line
	};
